...
local class_icons = icons.by_class
...
function M.init()
    awful.screen.connect_for_each_screen(function(s)
        ...
        local function set_icon(item, c)
            ...
            item:get_children_by_id('text_icon')[1].markup = "<span color='#f6e3c9' font='Fira Code Nerd Font'>"..i.."</span>"
        end
        ...
        s.window_switcher = awful.popup({
            ...
            widget = {
                ...
                border_width = beautiful.tasklist_border_width,
